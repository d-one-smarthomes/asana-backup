...
- **Assignee**: Unassigned
- **Due**: None
- **Notes**: Project/client name | Description of issue | Is it constant or intermittent? | When did it start?
...
### Set an appointment if a technician is needed in person
- **Status**: Incomplete
- **Assignee**: Unassigned
- **Due**: None
- **Notes**: (none)

### After job is complete, the technician logs the task + time in Asana (which feeds Harvest)
- **Status**: Incomplete
- **Assignee**: Unassigned
- **Due**: None
- **Notes**: (none)
...
### Assign task back to @accounts
- **Status**: Incomplete
- **Assignee**: Unassigned
- **Due**: None
- **Notes**: (none)

### Accounts bills the client as per Harvest
- **Status**: Incomplete
- **Assignee**: Unassigned
- **Due**: None
- **Notes**: (none)
